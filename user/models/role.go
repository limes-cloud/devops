...
func (u *Role) One(query interface{}, f ...callback) error {
...
func (u *Role) Page(query interface{}, page, count int64, f ...callback) ([]Role, int64, error) {
	var list []Role
	var total int64
	db := database().Table(u.Table())
	if query != nil {
...
func (u *Role) All(query interface{}, f ...callback) ([]Role, int64, error) {
	var list []Role
	var total int64
	db := database().Table(u.Table())
	if query != nil {
...
func (u *Role) Update(ctx context.Context, c interface{}, m interface{}, f ...callback) error {

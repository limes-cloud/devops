...
var (
	...
	//auth相关
	DulDeviceLoginError = &gin.CustomError{Code: 1000020, Msg: "你已在其他设备登陆"}
	NotResourcePower    = &gin.CustomError{Code: 1000021, Msg: "暂无接口资源权限"}
	TokenValidateError  = &gin.CustomError{Code: 1000022, Msg: "token验证失败"}
